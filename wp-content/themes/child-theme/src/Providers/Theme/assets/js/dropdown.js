 ...
 */
export function closeDropdown(toggle) {
 ...
 * @param {HTMLElement} toggle
 */
export function openDropdown(toggle) {
 ...
 */
export function selectItem(dropdown, item) {
 ...
 * @returns {HTMLElement[]}
 */
export function getItems(dropdown) {
 ...
 */
export function moveFocus(dropdown, direction) {
