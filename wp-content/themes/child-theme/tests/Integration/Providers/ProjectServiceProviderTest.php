...
/**
 * Integration tests for ProjectServiceProvider.
 */
class ProjectServiceProviderTest extends BaseTestCase
{
    private ProjectServiceProvider $provider;

    public function set_up(): void
    {
        parent::set_up();
        $this->provider = new ProjectServiceProvider();
    }
    ...
    {
        $this->assertInstanceOf(ProjectServiceProvider::class, $this->provider);
    }
    ...
    {
        $configPath = dirname(__DIR__, 3) . '/src/Providers/ProjectService/config/post-type.json';
