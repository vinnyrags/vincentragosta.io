...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size">WordPress, PHP, JavaScript, TranslatePress</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading"><strong>Broadway's biggest franchise needed a digital platform that could evolve across eras.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Two builds, two different eras of the same franchise — each requiring a platform that could serve a global audience buying tickets across Broadway, national tours, and international productions simultaneously.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>A custom ticket calendar, multilingual architecture, and interactive backgrounds built for a global theatrical brand.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Both builds ran on WordPress with custom theme architecture — structured content managed through dedicated field groups so the marketing team could update show schedules, cast announcements, and promotional campaigns without developer involvement.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>Seven years of continuous operation, two successful launches, zero platform migrations.</strong></h2>
<!-- /wp:heading -->
