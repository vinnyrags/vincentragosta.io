...
<div class="wp-block-group alignfull" id="results"><!-- wp:columns -->
    <div class="wp-block-columns"><!-- wp:column {"width":"40%"} -->
        ...
        <!-- wp:column -->
        <div class="wp-block-column"><!-- wp:heading -->
            <h2 class="wp-block-heading"><strong>270% increase in traffic to the pages that matter most.</strong></h2>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"className":"is-style-muted"} -->
            <p class="is-style-muted">This project stands as one of my personal favorites — the rare intersection of complex data architecture, a design system with genuine character, and a client mission that made the work feel meaningful. The platform continues to serve an institution that has supported writers for over two centuries.</p>
            <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
    <!-- /wp:columns --></div>
<!-- /wp:group -->