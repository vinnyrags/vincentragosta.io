...
<div class="wp-block-group alignfull" id="results"><!-- wp:columns -->
    <div class="wp-block-columns"><!-- wp:column {"width":"40%"} -->
        ...
        <!-- wp:column -->
        <div class="wp-block-column"><!-- wp:heading -->
            <h2 class="wp-block-heading"><strong>Three Tony Awards, $10 million at the box office, and a platform that carried the production into a national tour.</strong></h2>
            <!-- /wp:heading -->
