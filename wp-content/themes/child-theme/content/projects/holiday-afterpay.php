...
<div class="wp-block-group alignfull" id="implementation" style="margin-top:0"><!-- wp:columns -->
    <div class="wp-block-columns"><!-- wp:column {"width":"40%"} -->
        ...
        <!-- wp:column -->
        <div class="wp-block-column"><!-- wp:heading -->
            <h2 class="wp-block-heading"><strong>A single-page building facade with shoppable windows, animated snow, and the most demanding CSS layout I have built.</strong></h2>
            <!-- /wp:heading -->
