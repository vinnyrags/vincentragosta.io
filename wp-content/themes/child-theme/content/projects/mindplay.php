    ...
    <div class="wp-block-columns"><!-- wp:column {"width":"40%"} -->
        <div class="wp-block-column" style="flex-basis:40%"><!-- wp:separator {"className":"is-style-wide","style":{"spacing":{"margin":{"bottom":"0"}}}} -->
            ...
            <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--30)"><!-- wp:paragraph {"className":"is-style-muted","fontSize":"10"} -->
                ...
                <!-- wp:paragraph {"fontSize":"30"} -->
                <p class="has-30-font-size"><a href="https://mindplaynyc.com">https://mindplaynyc.com</a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
        ...
        <div class="wp-block-column"><!-- wp:paragraph -->
            <p>Full-stack development for the official website of Mindplay — the Off-Broadway solo show from Drama Desk-nominated mentalist Vinny DePonto, produced by Eva Price and Thomas Kail. Custom WordPress theme with a ticketing calendar, a dark and sophisticated design system, and frontend work that translated the show's mysterious, intimate aesthetic into a digital experience.</p>
            <!-- /wp:paragraph -->
