...
use IX\Providers\Blog\Hooks\EnablePosts;
...
class BlogProvider extends Provider
{
    ...
    public function enqueueSingleAssets(): void
    {
        ...
        $this->enqueueParentDistStyle('ix-blog-single', 'css/blog.css');
    }
    ...
    {
        $this->enqueueParentDistStyle('ix-blog-block', 'css/blog.css');
    }
    ...
    {
        $this->enqueueParentDistScript('ix-blog-editor', 'js/blog.js', [
            'wp-blocks',
            'wp-element',
            'wp-block-editor',
            'wp-components',
