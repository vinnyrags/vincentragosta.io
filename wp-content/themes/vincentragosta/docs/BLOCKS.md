...
**Block name:** `vincentragosta/hero`
...
**Usage:**
```html
<!-- wp:vincentragosta/hero {"svgAsset":"home-page","align":"full"} -->
<!-- wp:heading -->
<h1>Welcome</h1>
<!-- /wp:heading -->
<!-- wp:buttons -->
...
**Block name:** `vincentragosta/shutter-cards`
...
**Block name:** `vincentragosta/shutter-card`
...
**Block name:** `vincentragosta/projects`
...
WordPress applies wrapper classes (`wp-block-vincentragosta-*`) to blocks. Mixing WordPress classes with custom BEM classes creates specificity issues.
...
.wp-block-vincentragosta-my-block {
    // Don't do this
}
```
