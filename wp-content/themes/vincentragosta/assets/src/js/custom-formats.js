...
const INLINE_BLOCK_FORMAT_TYPE = 'vincentragosta/inline-block';
...
const UNDERLINE_FORMAT_TYPE = 'vincentragosta/underline'; // Using your namespace for consistency

const UnderlineFormatButton = ({ isActive, value, onChange }) => {
    return (
        <RichTextToolbarButton
            icon="editor-underline"
            title={__('Underline', 'vincentragosta')}
            onClick={() => {
                onChange(
                    toggleFormat(value, {
