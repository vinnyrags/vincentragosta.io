...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size">20XX</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size"><a href="https://#">https://#</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel porttitor nisi, in cursus orci. Donec nunc orci, ornare nec purus in, luctus sodales massa. Etiam est libero, dignissim sit amet libero in, maximus vehicula velit. Praesent vestibulum quam molestie nisi semper, et luctus purus feugiat.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Lorem ipsum sit amet dolor</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
