...
/**
 * Integration tests for the TwigServiceProvider class.
 */
class TwigServiceProviderTest extends BaseTestCase
{
    /**
     * Test that TwigServiceProvider implements Registrable.
     */
    ...
    {
        $childProvider = new class extends TwigServiceProvider {
