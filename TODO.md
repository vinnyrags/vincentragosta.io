...
- dedicated about page / talk more in depth about how i view AI and how I integrate it into my workflow.
- unless we are hovering over an active shutter card, dont animate on hover for inactive shutter card (i am specifically talking about the plus rotating to a close, since we arent closing anything on hover)
