...
- js functionality to read all headings with id on them and have a visual scroll bar with buttons that deeplink to those sections on the page (do this on project detail template only)
...
- deeplink css smooth transition
