 ...
 * refund-policy), /gaming, /cards, /collection, /the-discord
    ...
    [
        ...
        'sections'      => [
            ...
            [
                ...
                'content' => '<p>Some purchases are <strong>speculative</strong> — pull-box entries, individual booster packs, and pack-battle buy-ins. You\'re paying to see what you get. For these items, the buy-in price covers only the card itself; <strong>shipping is not charged at checkout</strong>.</p><p>Your card is opened on stream so you see what you pulled. After the stream, you choose what happens next:</p><ul><li><strong>Pay shipping</strong> ($10 US / $25 international for the period) and your card ships with the next batch — Mondays for US, monthly for international. If your Discord account is linked to your purchase email, you\'ll receive a DM at the end of stream with a one-click checkout link.</li><li><strong>Take no action</strong> and the card stays in our inventory. We hold it for <strong>4 weeks</strong> — if shipping isn\'t paid in that window, the card returns to our pulling pool to be drawn by another buyer in a future box.</li></ul><p><strong>One shipping payment per period covers everything you buy that period.</strong> If you grab a pull early in the week and a sealed box later, it all ships together with one charge — no extra DM needed; the box\'s shipping covers the pull.</p><p><strong>You\'ll only hear from us once</strong> after each fresh speculative purchase. If you ignored a previous DM and don\'t make any new pull-or-pack purchases, we won\'t ping you again. The next one only fires when you make another speculative buy that doesn\'t roll into a committed shipping payment.</p>',
            ],
        ],
    ],
    [
