...
Create `content/projects/[PROJECT_NAME].php` using the exact block markup from the guide file. The filename should be the project name in kebab-case. Update these fields:
