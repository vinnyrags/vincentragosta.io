...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>A custom WordPress build with a ticketing calendar and frontend layouts that matched the show's visual ambition.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>A record-breaking premiere, 15 Tony nominations, and a platform that carried the show for six years.</strong></h2>
<!-- /wp:heading -->
