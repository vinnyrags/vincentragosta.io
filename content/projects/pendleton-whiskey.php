...
<h2 class="wp-block-heading"><strong>A heritage spirits brand needed a digital platform that could survive an ownership change.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">The platform needed to serve two masters — maintain continuity for existing brand equity while providing the infrastructure for Proximo's expanded marketing ambitions post-acquisition.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>Event-driven content architecture built for campaign velocity and regulatory compliance.</strong></h2>
<!-- /wp:heading -->
