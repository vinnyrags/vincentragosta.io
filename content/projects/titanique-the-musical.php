...
<h2 class="wp-block-heading"><strong>A scrappy Off-Broadway parody needed a digital presence that punched above its weight.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>A simple design system built to scale — from a downtown theatre to eight cities worldwide.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>Three years Off-Broadway, an Olivier Award, eight cities, and now — Broadway.</strong></h2>
<!-- /wp:heading -->
