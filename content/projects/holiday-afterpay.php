...
<p class="has-30-font-size">Block, Inc.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size">HTML, CSS, JavaScript</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size"><a href="https://holiday.afterpay.com" target="_blank" rel="noopener">https://holiday.afterpay.com</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p>Afterpay's 2021 holiday campaign microsite — an interactive, single-page experience built as a multi-story building facade where each window showcased shoppable products. Animated snow effects, precision CSS positioning across dozens of interactive hotspots, and vanilla JavaScript throughout. No framework, no CMS, just the most technically demanding frontend build of my career delivered on a hard holiday deadline.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Sole developer, working directly with Block, Inc. (formerly Square).</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading"><strong>The biggest buy-now-pay-later brand in the world needed a holiday microsite — and it needed it fast.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">The brief was clear: build something visually ambitious on a holiday deadline — no extensions, no phased rollout, live or nothing.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
