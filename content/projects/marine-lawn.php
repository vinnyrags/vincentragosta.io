...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size"><a href="https://marineandlawn.com" target="_blank" rel="noopener">https://marineandlawn.com</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p>The digital platform behind Marine &amp; Lawn Hotels &amp; Resorts — AJ Capital Partners' luxury golf hospitality brand spanning Scotland and Northern Ireland. A 1.5-year engagement building a network of interconnected WordPress sites with booking integration, property-specific content architecture, and a phased rollout coordinated with hotel renovations and openings across six properties.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Sole developer, working directly with AJ Capital Partners. The project that launched my freelance practice.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
