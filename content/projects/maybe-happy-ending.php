...
<h2 class="wp-block-heading"><strong>A South Korean musical making its Broadway debut needed a digital platform built for the spotlight.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>A media-rich Broadway build with integrated ticketing and a multi-platform stream selector.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>Six Tony Awards — including Best Musical — and a platform that carried the entire campaign.</strong></h2>
<!-- /wp:heading -->
