...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size">TypeScript, Vue.js, REST APIs</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"30"} -->
<p class="has-30-font-size"><a href="https://criterionticketing.com" target="_blank" rel="noopener">https://criterionticketing.com</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p>The project where I stepped farthest outside my primary stack. Criterion is a TypeScript and Vue.js ticketing platform built for <a href="https://vincentragosta.io/projects/roundabout-theatre/">Roundabout Theatre Company</a>'s Broadway venue rentals — a deliberate departure from the WordPress and PHP work that defined most of my Situation tenure. Like the Drupal build for <a href="https://vincentragosta.io/projects/adl/">ADL</a> and the Rails integration on <a href="https://vincentragosta.io/projects/villatel/">Villatel</a>, this project demonstrated that the architectural thinking transfers even when the language and framework change entirely. The platform earned a Webby Award Honoree recognition for Best User Experience.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Frontend lead at Situation Interactive, built under Situation's Hatch innovation program.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>A typed frontend architecture built to model the complexity of Broadway ticketing.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">The type system wasn't overhead — it was the reason the platform could move fast without breaking. Every API response, every state transition, every user interaction was validated at compile time, not discovered in production.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading -->
<h2 class="wp-block-heading"><strong>Webby-honored, processing real Broadway transactions from day one.</strong></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Criterion launched in July 2022 with &amp; Juliet as its first production, processing primary ticket sales across Roundabout's three Broadway venues from day one. The platform gave Roundabout something no external ticketing vendor could: direct ownership of the patron relationship, full visibility into purchase data, and the ability to integrate programs like HipTix — their $30 ticket initiative for theatregoers ages 18-40 — natively into the purchase flow rather than as a bolt-on afterthought. The platform expanded to include native iOS and Android apps, extending the same typed architecture to mobile. In 2024, Criterion was recognized as a Webby Award Honoree in the Best User Experience category — validation from the International Academy of Digital Arts and Sciences that the UX investment paid off.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-muted"} -->
<p class="is-style-muted">Criterion remains in active production, processing ticket sales for every rental production across Roundabout's Broadway houses — a platform built once and scaled to handle the full volume of one of New York's busiest theatre operations.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
