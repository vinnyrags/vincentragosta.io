...
const messages = [
    ...
    // Message 6: Giveaways
    {
        ...
        description: [
            ...
            '',
            '**`!giveaway draw`** — Instant random winner (no animation). Assigns Aha role, announces in #giveaways and #announcements.',
            '',
            '**`!giveaway draw duckrace`** — Load giveaway entries as a duck race roster for stream drawing.',
            '',
            '**`!giveaway cancel`** — Cancel the giveaway.',
            '',
            '**`!spin giveaway`** — Animated wheel spin to draw giveaway winner. Decelerating spinner, ~15 sec. Same post-draw actions as `!giveaway draw`.',
            '',
