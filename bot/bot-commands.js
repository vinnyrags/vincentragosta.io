...
const messages = [
    ...
    // Message 8: Other Commands
    {
        ...
        description: [
            ...
            '',
            '**`!link email@example.com`** — Link Discord account to shop email (for role upgrades). Bot deletes the message to protect email.',
            '',
