...
const messages = [
    ...
    // Message 6: Giveaways
    {
        ...
        description: [
            ...
            '',
            '**`!giveaway draw`** — Random winner. Assigns Aha role, announces in #giveaways and #announcements.',
            '',
            '**`!giveaway draw duckrace`** — Load giveaway entries as a duck race roster for stream drawing.',
            '',
            '**`!giveaway cancel`** — Cancel the giveaway.',
            '',
            '*Only verified members (Xipe role) can enter. One entry per person. Entry roster shows Discord + TikTok username (social mode). Social copy posted to #ops.*',
        ].join('\n'),
        color: 0xceff00,
    },
